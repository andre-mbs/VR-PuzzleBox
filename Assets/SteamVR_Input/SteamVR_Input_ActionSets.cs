...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_TriggerActions p_TriggerActions;
        ...
        public static SteamVR_Input_ActionSet_TriggerActions TriggerActions
        {
            get
            {
                return SteamVR_Actions.p_TriggerActions.GetCopy<SteamVR_Input_ActionSet_TriggerActions>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_TriggerActions = ((SteamVR_Input_ActionSet_TriggerActions)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_TriggerActions>("/actions/TriggerActions")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.TriggerActions};
        }
    }
}
